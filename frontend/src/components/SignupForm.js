          ...
          <form onSubmit={handleSignup}>
            <label className="form-control w-full ">
              <div className="label">
                ...
                <span className="label-text-alt text-[9px] lg:text-lg">input your email address</span>
              </div>
              <input
            ...
            <label className="form-control w-full ">
              <div className="label">
                ...
                <span className="label-text-alt text-[9px] lg:text-lg">Input your password</span>
              </div>
              <input
                onChange={store.updateSignupForm}
